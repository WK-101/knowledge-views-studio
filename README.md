...
- **Mobile works, but is newly supported.** Every touch interaction has a real pointer-based path —
  ...
  them.
- **The search has never been evaluated for relevance.** There are 639 tests proving the code does what it
...
**New, and looking for people to break it.** The logic is covered by **639 unit tests**, the code is
