...
object NoteRichRenderer {
    ...
    fun buildDocument(source: String, theme: Theme, images: Map<String, String> = emptyMap()): String {
        ...
        return buildString {
            ...
            append("</head><body><div class=\"hexis-note\">").append(body).append("</div>")
    ...
    private fun css(t: Theme) = """
        ...
        .hexis-note{padding:14px 16px 40px;${if (t.measureCh > 0) "max-width:${t.measureCh}ch;margin:0 auto;" else ""}}
