 ...
 * never vanishes. Date/time tokens ({{date}}/{{time}}) belong to [com.wkhan.hexis.domain.NoteTokens]
...
object NoteTransclusion {
    ...
    private val TOKEN = Regex("\\{\\{(today|tasks|note|notes|events|habits|time|goal)(?::([^}]*))?\\}\\}")
