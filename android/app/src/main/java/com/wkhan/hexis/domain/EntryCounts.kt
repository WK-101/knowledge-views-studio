...
import com.wkhan.hexis.domain.view.Filters
...
object EntryCounts {
    ...
    fun compute(
        ...
        val (hiddenListIds, hiddenFolderIds) = com.wkhan.hexis.domain.view.ListPipeline.hiddenContainers(lists, folders)
        val anyHidden = hiddenListIds.isNotEmpty() || hiddenFolderIds.isNotEmpty()
        fun notHidden(t: TaskEntity) = !anyHidden || !com.wkhan.hexis.domain.view.ListPipeline.isHiddenContainerTask(t, hiddenListIds, hiddenFolderIds)
