...
data class NoteEntity(
    ...
    // reveal reminder (the existing engine) resurfaces it. Reuses Hexis's sealed-letter idea for any note.
    val sealedUntil: Long? = null,
    // P7 (v74): derived render data materialized on save (see [com.wkhan.hexis.domain.NoteDerived])
 ...
 * that already resurfaces whole notes also brings due cards back. See [com.wkhan.hexis.domain.NoteCards].
 */
@Serializable
 ...
 * filter itself is a [com.wkhan.hexis.domain.NotePredicate] serialized into [predicateJson]; the
