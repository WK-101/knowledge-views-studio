...
import com.wkhan.hexis.data.entity.CravingEventEntity
import com.wkhan.hexis.data.entity.ExperimentEntity
...
object ThirdWave {
    ...
    fun analyzeExperiment(exp: ExperimentEntity, habit: HabitEntity, checkins: List<HabitCheckinEntity>, tasks: List<TaskEntity>, today: Long, zone: java.time.ZoneId = java.time.ZoneId.systemDefault(), dayLogs: List<com.wkhan.hexis.data.entity.DayLogEntity> = emptyList()): ExperimentResult? {
