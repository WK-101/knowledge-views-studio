...
object FourthWave {
    ...
    fun causalPrecursors(
        ...
        dayLogs: List<com.wkhan.hexis.data.entity.DayLogEntity> = emptyList(),
    ): List<CausalEdge> {
