...
/**
 * Wave O — a device-independent, passphrase-encrypted backup (CypherLeaf's portable-backup idea). Hexis's
...
object PortableCrypto {
    private const val MAGIC = "hexis-encrypted-backup"
     ...
     *  non-Hexis/unsupported blob — never throws for those. */
