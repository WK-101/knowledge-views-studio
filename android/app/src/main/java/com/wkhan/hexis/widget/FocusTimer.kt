 ...
 */
object FocusTimer {
    const val ACTION_START = "com.wkhan.hexis.action.FOCUS_TIMER_START"
    const val ACTION_STOP = "com.wkhan.hexis.action.FOCUS_TIMER_STOP"
    const val ACTION_DONE = "com.wkhan.hexis.action.FOCUS_TIMER_DONE"
