package com.wkhan.hexis.domain.habit
...
object HabitStats {
     ...
     */
    fun isSuccessDay(habit: HabitEntity, checkin: com.wkhan.hexis.data.entity.HabitCheckinEntity): Boolean =
     ...
     */
    fun isWinDay(habit: HabitEntity, epochDay: Long, checkin: com.wkhan.hexis.data.entity.HabitCheckinEntity?): Boolean =
    ...
    fun daySets(habit: HabitEntity, checkins: List<com.wkhan.hexis.data.entity.HabitCheckinEntity>): DaySets {
     ...
     */
    fun typicalDoneMinute(checkins: List<com.wkhan.hexis.data.entity.HabitCheckinEntity>, minSamples: Int = 4): Int? {
