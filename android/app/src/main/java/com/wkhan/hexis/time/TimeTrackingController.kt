...
import com.wkhan.hexis.reminders.AutomationRunner
import com.wkhan.hexis.reminders.TimeIntentApi
import com.wkhan.hexis.util.TrackShortcuts
import com.wkhan.hexis.widget.TimeWidget
 ...
 * the pure statistics/reports live in [com.wkhan.hexis.domain.FocusStats] and
 * [com.wkhan.hexis.domain.TimeReports]. This holds only the imperative side: repo writes, the
...
class TimeTrackingController(
    ...
    private fun refreshHabitWidgets() {
        ...
        com.wkhan.hexis.widget.MomentumWidget.refresh(context)
    }
