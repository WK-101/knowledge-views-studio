...
data class AppSettings(
    ...
    val notesLiveStyle: Boolean = true,
    val notesReadingTheme: String = "match",   // match | paper | sepia | graphite | solarized | midnight | hexis
    val notesFont: String = "system",          // system | serif | sans | mono
    val notesFontScale: Int = 100,             // 85..150 (%)
    ...
    // automation app's package here; blank means Hexis emits no outgoing events at all (the safe default).
    ...
    val activeRoutineRunJson: String = "",  // the single in-progress run, so a routine survives being killed mid-run
    ...
    fun toMap(): Map<String, String> = mapOf(
        ...
        Keys.NOTES_READING_THEME to notesReadingTheme,
        Keys.NOTES_FONT to notesFont,
        Keys.NOTES_FONT_SCALE to notesFontScale.toString(),
        ...
        Keys.ACTIVE_ROUTINE_RUN to activeRoutineRunJson,
    ...
    object Keys {
        ...
        const val NOTES_READING_THEME = "notes_reading_theme"
        const val NOTES_FONT = "notes_font"
        const val NOTES_FONT_SCALE = "notes_font_scale"
        ...
        const val ACTIVE_ROUTINE_RUN = "active_routine_run"
    ...
    companion object {
        ...
        fun fromMap(m: Map<String, String>): AppSettings = AppSettings(
            ...
            notesFontScale = m[Keys.NOTES_FONT_SCALE]?.toIntOrNull() ?: 100,
            ...
            activeRoutineRunJson = m[Keys.ACTIVE_ROUTINE_RUN] ?: "",
