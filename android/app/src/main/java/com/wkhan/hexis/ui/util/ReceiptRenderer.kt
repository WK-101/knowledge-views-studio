package com.wkhan.hexis.ui.util
...
import com.wkhan.hexis.domain.done.DoneStats
import com.wkhan.hexis.domain.done.Integrity
...
object ReceiptRenderer {
    fun render(a: Accomplishment, listName: String?, zone: ZoneId = ZoneId.systemDefault()): Bitmap {
        ...
        c.drawText("Hexis · sealed on-device", x, footY + 40f, attr)
    ...
    fun renderCertificate(year: Int, stats: DoneStats, chainHead: String, headCount: Int): Bitmap {
        ...
        centered("Hexis — generated on-device, $year", cardRect.bottom - 96f,
