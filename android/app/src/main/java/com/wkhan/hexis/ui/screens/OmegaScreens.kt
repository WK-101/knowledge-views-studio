...
import com.wkhan.hexis.domain.PeriodRecap
 ...
 */
private fun commandCatalog(s: com.wkhan.hexis.domain.AppSettings): List<Pair<String, List<Pair<String, String>>>> {
    val habits = com.wkhan.hexis.domain.Modules.isEnabled(s, com.wkhan.hexis.domain.Modules.HABITS)
    val time = com.wkhan.hexis.domain.Modules.isEnabled(s, com.wkhan.hexis.domain.Modules.TIME)
    val notes = com.wkhan.hexis.domain.Modules.isEnabled(s, com.wkhan.hexis.domain.Modules.NOTES)
...
fun RecapScreen(vm: AppViewModel, initialStartDay: Long, initialEndDay: Long, initialTitle: String, onBack: () -> Unit, onOpenNote: (String) -> Unit = {}) {
    ...
    fun shareRecap() {
        runCatching {
            ...
            val rd = com.wkhan.hexis.util.DayCard.RecapData(
                title = title,
            ...
            val bmp = com.wkhan.hexis.util.DayCard.renderRecap(rd)
            val res = com.wkhan.hexis.util.ProgressCard.saveAndShareUri(shareCtx, bmp, "hexis-recap-$start-$end.png")
            res.shareUri?.let { com.wkhan.hexis.util.ProgressCard.share(shareCtx, it) }
        }
    }

    Scaffold(topBar = {
        HexisTopBar(title = "Recap", onBack = onBack, actions = {
