...
import com.wkhan.hexis.reminders.FocusDnd
import com.wkhan.hexis.util.Sounds
 ...
 * cues hang off the same two calls. The pure statistics live in [com.wkhan.hexis.domain.FocusStats];
