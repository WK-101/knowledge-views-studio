package com.wkhan.hexis.ui.theme
...
/**
 * Hexis's semantic colour tokens — the one place status hues, the favourite star, and the
 * categorical chart palette are defined. Every screen reads these through [LocalHexisColors]
...
val LightHexisColors = HexisColors(
...
val DarkHexisColors = HexisColors(
...
val LocalHexisColors = staticCompositionLocalOf { LightHexisColors }
