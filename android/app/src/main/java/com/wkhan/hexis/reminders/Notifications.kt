...
object Notifications {
    ...
    fun refreshOccasion(context: Context, occasions: List<com.wkhan.hexis.data.entity.CountdownEntity>) {
        ...
        val date = com.wkhan.hexis.domain.LifeEvent.nextOccurrence(c, today)
        val emoji = c.emoji ?: com.wkhan.hexis.domain.LifeEvent.type(c).emoji
        ensureChannel(context)
    ...
    fun showTrackPrompt(context: Context, taskId: String, title: String, activityId: String) {
        ensureChannel(context)
        val start = Intent(context, com.wkhan.hexis.widget.TimeTrackReceiver::class.java)
            .setAction(com.wkhan.hexis.widget.ACTION_START)
            .putExtra(com.wkhan.hexis.widget.TimeTrackReceiver.EXTRA_ACTIVITY_ID, activityId)
            .putExtra(com.wkhan.hexis.widget.TimeTrackReceiver.EXTRA_TASK_ID, taskId)
