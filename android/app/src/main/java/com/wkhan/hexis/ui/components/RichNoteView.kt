...
import com.wkhan.hexis.util.NoteRichRenderer
...
fun RichNoteView(
    ...
    val theme = remember(cs, readingThemeId, type) {
        val rt = com.wkhan.hexis.domain.NoteAppearance.theme(readingThemeId)
    ...
    AndroidView(
        ...
        factory = { ctx ->
            // SEC (R2-C) — the HexisSplitDiag traces are a dev aid; keep them out of release logcat. Gate on
            ...
            if (softwareLayer && diag) android.util.Log.d("HexisSplitDiag", "RichNoteView WebView factory (creating; software layer)")
            WebView(ctx).apply {
                ...
                webViewClient = object : WebViewClient() {
                    ...
                    override fun onPageFinished(view: WebView, url: String?) {
                        if (softwareLayer && diag) android.util.Log.d("HexisSplitDiag", "RichNoteView onPageFinished (software=$softwareLayer)")
