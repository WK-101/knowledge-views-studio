 ...
 * most of Kairo's shortcuts — "New note", "Today's note", "Close day" and the dynamic "Track: …" ones —
 ...
 */
object AppShortcuts {
    private const val PKG = "com.wkhan.kairo"
    private const val MAIN = "com.todocompanion.app.MainActivity"
    private const val QUICK = "com.todocompanion.app.widget.QuickCaptureActivity"
    ...
    data class Spec(
        ...
        val iconRes: Int,
        val data: String,          // the todocompanion:// deep-link that routes it
