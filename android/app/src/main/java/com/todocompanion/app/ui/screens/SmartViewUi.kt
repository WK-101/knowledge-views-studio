...
private val SV_FIELDS = listOf(
    ...
    "kind" to "Kind is (note/journal/meeting)", "olderThanDays" to "Older than (days)",
...
private fun svNeedsValue(field: String) = field in setOf("titleContains", "bodyContains", "textContains", "kind", "olderThanDays")
