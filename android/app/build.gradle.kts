...
dependencies {
    ...
    // #8 — collectAsStateWithLifecycle(): stops flow collection at STOPPED so WhileSubscribed upstreams
    // can cancel while the app is backgrounded, instead of collectAsState()'s collect-until-disposed.
