...
| **Messaging** | **Message any number without adding it to your contacts** on WhatsApp, Signal, Telegram or Viber — opened directly in the app, never through a browser, with the right country for local numbers; from Recents, number history, the keypad, the missed-call notification, or **text you select or share in any app**; "save as a temporary contact?" afterwards (private by default); newer WhatsApp versions may still ask to sync contacts, which you can decline; "Send my details" |
...
| Contacts | Search (also addresses, notes, companies, websites, handles), Labels, Lock now (with the app lock) | Select all, Find & merge duplicates, Contacts settings (label/account/private filter chips and "Temporary (n)" stay above the list, then "My card") |
...
| Messaging | Quick reply messages, My card (replaces "My details"; also at the top of Contacts) |
