...
object ContactDetailsJson {
    fun encode(d: ContactDetails): String = JSONObject().apply {
        ...
        put("phones", items(d.phones)); put("emails", items(d.emails)); put("sites", items(d.websites))
    ...
    fun decode(s: String): ContactDetails {
        ...
        return ContactDetails(
            ...
            phones = readItems(o.optJSONArray("phones")), emails = readItems(o.optJSONArray("emails")), websites = readItems(o.optJSONArray("sites")),
