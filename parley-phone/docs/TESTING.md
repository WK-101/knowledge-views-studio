...
## 15. v3.2 (round 5, COMPETITIVE_ANALYSIS_5; the roadmap calls these the "§14 v3.2" device checks)

### Circle: interactions, "Log this?", kind reminders, dates (R1–R5, U4, G4–G6)
