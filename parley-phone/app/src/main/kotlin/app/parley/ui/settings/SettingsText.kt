...
object SettingsText {
    private val entries: Map<String, Triple<Int, Int, Int>> = mapOf(
        ...
        "calls_layout" to Triple(R.string.surf_set_calls_layout_title, R.string.surf_set_calls_layout_summary, R.string.surf_set_calls_layout_kw),
        "favorites_in_contacts" to Triple(R.string.surf_set_fav_contacts_title, R.string.surf_set_fav_contacts_summary, R.string.surf_set_fav_contacts_kw),
        "recent_tap" to Triple(R.string.surf_set_recent_tap_title, R.string.surf_set_recent_tap_summary, R.string.surf_set_recent_tap_kw),
